...
AUETC_Proyecto_FinalCharacter::AUETC_Proyecto_FinalCharacter()
{
...
void AUETC_Proyecto_FinalCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AUETC_Proyecto_FinalCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AUETC_Proyecto_FinalCharacter::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUETC_Proyecto_FinalCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUETC_Proyecto_FinalCharacter::TouchStopped);
...
{
	// If UETC_Proyecto_Final is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in UETC_Proyecto_Final.Build.cs is not automatically propagated
...
void AUETC_Proyecto_FinalCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AUETC_Proyecto_FinalCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}

void AUETC_Proyecto_FinalCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUETC_Proyecto_FinalCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
